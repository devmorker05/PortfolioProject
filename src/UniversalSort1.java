 ...
 */
public class UniversalSort1L implements UniversalSort {
    ...
    @Override
    public void transferFrom(UniversalSort1L source) {
        assert source instanceof UniversalSort1L : "Violation of: source is UniversalSortArrayList";
        UniversalSort1L localSource = (UniversalSort1L) source;
